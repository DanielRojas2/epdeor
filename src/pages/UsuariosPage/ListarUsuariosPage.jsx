...
export default function ListarUsuariosPage() {
    ...
    const handleEstado = async (usuario) => {
        ...
        const url = `http://127.0.0.1:8000/usuarios/perfiles/${usuario.id}/`;
                            ...
                            {usuariosPaginados.length > 0 ? (
                                usuariosPaginados.map((u, idx) => (
                                    ...
                                    <TableCell align="center">
                                        ...
                                        <Tooltip title={u.estado ? "Dar de baja" : "Dar de alta"}>
                                        <IconButton
                                            color={u.estado ? "error" : "success"}
                                            onClick={() => handleEstado(u)}
                                        >
                                            {u.estado ? <DeleteIcon /> : <RestoreIcon />}
                                        </IconButton>
                                        </Tooltip>
                                    </TableCell>
                                    </TableRow>
